...
public class TransferMoneyController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(customerService.isCustomerExists(receiverId))
		{
			//sender balance should not be less than the amount to transfer
				...
				if(customerService.transferAmount(senderId, receiverId, amount)) {
					//sender balance should not be less than the amount to transfer
					out.println("<body bgcolor=gray style=padding:200px><h2 style=text-align:center;color:maroon>Insufficient Balance!!!, Available Balance:"+balance);;
				...
				{
				out.println("<body style=text-align:center;padding:200px><h2 style=color:maroon>Transferred Successfully!!</h2>");
		...
		else
		{
			...
			out.println("<body bgcolor=gray style=padding:200px><h2 style=text-align:center;color:maroon>Incorrect Receiver ID ,Please Try Again!");
			out.println("<h2 style=text-align:center><a href=transferAmount.jsp>TRY AGAIN!</a></h2>");
