...
public class EmployeeController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().println("<body style=text-align:center;padding:200px;backgroud-color:gray><h1>"+employeeName + ", congrats you have successfully opened an account in our bank");
