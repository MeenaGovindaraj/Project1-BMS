 ...
 */
public class AutenticateEmployee extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    
    public AutenticateEmployee() {
        super();
    }
		...
		//validating against id and password
			...
			if(employeeService.isEmployeeExists(employeeId))
			{
					if(employeeService.validateEmployee(employeeId,password))
					{
						...
						out.println("<body bgcolor=gray style=padding:200px><h3 style=text-align:center>You Are Logged in at :"+ new java.util.Date()+"</h3>");
					...
					else
					{
						...
						out.println("<body bgcolor=g style=padding:200px><h2 style=text-align:center>Incorrect Employee ID and password , Please Try Again!");
